...
let songs =[
    ...
    {songName:"Dj-Remix1",filePath:"songs/3.mp3",coverPath:"covers/3.jpg"},
    {songName:"Dj-Remix2",filePath:"songs/4.mp3",coverPath:"covers/4.jpg"},
    ...
    {songName:"Dj-Remix3",filePath:"songs/7.mp3",coverPath:"covers/7.jpg"},
    {songName:"Ocean song ",filePath:"songs/8.mp3",coverPath:"covers/8.jpg"},
    {songName:"Love me like you do",filePath:"songs/2.mp3",coverPath:"covers/9.jpg"},
    {songName:"Friends",filePath:"songs/2.mp3",coverPath:"covers/9.jpg"},
]
...
burger.addEventListener('click',()=>{
    if( home.style.opacity==0 &&   about.style.opacity==0){
